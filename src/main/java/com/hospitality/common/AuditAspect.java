package com.hospitality.common;

import com.hospitality.common.Auditable;
...
public class AuditAspect {
    ...
    @AfterReturning(value = "@annotation(com.hospitality.common.Auditable)", returning = "result")
