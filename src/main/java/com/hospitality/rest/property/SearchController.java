package com.hospitality.rest.property;
...
public class SearchController {
     ...
     */
    @ExceptionHandler(com.hospitality.exceptions.ResourceNotFoundException.class)
    public ResponseEntity<Map<String, String>> handleNotFound(
            com.hospitality.exceptions.ResourceNotFoundException ex) {
