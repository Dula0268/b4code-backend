...
public interface GuestPropertyRepository extends JpaRepository<GuestProperty, Long> {
    ...
    """)
    Page<GuestProperty> searchAvailableProperties(
    ...
    """)
    List<GuestProperty> searchAvailableProperties(
        @Param("destination") String destination,
        @Param("checkIn")     LocalDate checkIn,
        @Param("checkOut")    LocalDate checkOut,
        @Param("guests")      Integer guests,
