...
public class SearchService {
    ...
    private PropertySearchResult mapToPropertySearchResult(Property property, int guests, LocalDate checkIn,
        ...
        if (Boolean.TRUE.equals(property.getFreeCancellation()))
            amenityLabels.add("Free Cancellation");
        if (Boolean.TRUE.equals(property.getBreakfastIncluded()))
            amenityLabels.add("Breakfast Included");
        if (Boolean.TRUE.equals(property.getPetFriendly()))
            amenityLabels.add("Pet-Friendly");
        if (Boolean.TRUE.equals(property.getAccessibility()))
            amenityLabels.add("Accessibility");
    ...
    private PropertyDetailResult mapToPropertyDetailResult(Property property, LocalDate checkIn, LocalDate checkOut) {
        ...
        if (property.getAvgCleanliness() != null)
            breakdown.add(new ReviewBreakdownDTO("Cleanliness", property.getAvgCleanliness()));
        if (property.getAvgComfort() != null)
            breakdown.add(new ReviewBreakdownDTO("Comfort", property.getAvgComfort()));
        if (property.getAvgService() != null)
            breakdown.add(new ReviewBreakdownDTO("Service", property.getAvgService()));
        if (property.getAvgDining() != null)
            breakdown.add(new ReviewBreakdownDTO("Dining", property.getAvgDining()));
        if (property.getAvgLocation() != null)
            breakdown.add(new ReviewBreakdownDTO("Location", property.getAvgLocation()));
